...
4. Run MachSMT
  ...
  **Note** This script provides a demonstration of MachSMT. Specifically, this
  ...
  and provides example usage on how to use MachSMT to make predictions on  smt2
  benchmarks
...
To completely reproduce results, please see the artifact
[REAME.md](https://github.com/MachSMT/STTT-Artifact/blob/master/artifact/README.md)
...
clearly out of scope for this artifact. Since we were not able to include the
...
By default, MachSMT uses the SolverLogicEHM ML technique for predictions, 
